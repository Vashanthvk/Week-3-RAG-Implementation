...
def build_context(results):
    """
    Build the LLM context from either of the retrieval representations
    used by the project.

    Backward compatibility:
      1. Week 5/6 retrieval results:
         {"document": {"content": "...", "metadata": {...}}, ...}

      2. Agent-loop context documents:
         objects exposing:
             .page_content
             .metadata

    This normalization is intentionally local to context construction.
    It does not change retrieval, evaluation, source formatting, or any
    ...
    for index, result in enumerate(
        ...
        # --------------------------------------------------------
        # Representation A: existing Week 5/6 retrieval result
        # --------------------------------------------------------
        ...
        # --------------------------------------------------------
        # Representation B: LangChain/agent ContextDocument
        # --------------------------------------------------------
